...
let myVariableName = "possible";
let reversedString = console.log(reverseCharacters(myVariableName));
*/
...
function modifyString(str) {
  ...
  return `We put the ${subString} in ${funString}.`;
}
// Test Function
...
let shortFunString = "We";
console.log(modifyString(funString));
console.log(modifyString(shortFunString));
...
console.log(`“The area is ${getRectangleArea(6, 4)} cm^2.”`);
console.log(`“The area is ${getRectangleArea(6)} cm^2.”`);
